...
[ASSIGNMENT.md](ASSIGNMENT.md), external Milvus 적재 예시는 [MILVUS_USAGE.md](MILVUS_USAGE.md),
...
| 필수 플랫폼 | watsonx Orchestrate, watsonx.data Milvus external Knowledge Base |
| 문의 | Slack Q&A 채널 |
...
- 제공된 watsonx.data Milvus database를 external vector index로 연결한 Knowledge Base 기반 RAG
...
4. 문서를 전처리해 제공된 watsonx.data Milvus database에 적재하고, wxO Knowledge Base가 해당 external Milvus collection을 검색하게 설정합니다.
...
- [MILVUS_USAGE.md](MILVUS_USAGE.md): watsonx.data Milvus 적재, 검색, external KB 연결 가이드
- [WXAI_USAGE.md](WXAI_USAGE.md): watsonx.ai API key/project ID 확인과 SDK 연결 테스트
- [WXO_USAGE.md](WXO_USAGE.md): watsonx Orchestrate agent YAML, Python tool, external Milvus Knowledge Base 예시
